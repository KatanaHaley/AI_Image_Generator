...
const Home = () => {
  ...
  return (
    <>
         <div className="ml-20">
        <h1 className="font-extrabold text-white text-[35px]">The Community Showcase</h1>
        <p className="mt-8 text-[#666e75] text-[14px]">Browse through a collection of imaginative and visually stunning images generated by DALL-E AI</p>
